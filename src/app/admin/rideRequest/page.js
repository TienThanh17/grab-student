...
import { getRideRequestManagerService } from "@/services/adminService";
...
const columns = [
    ...
    { field: "pickUpLocation", headerName: "Vị trí đi", width: 350, cellClassName: "center-align" },
    { field: "dropOffLocation", headerName: "Vị trí đến", width: 350, cellClassName: "center-align" },
    { field: "status", headerName: "Trạng thái", width: 150, cellClassName: "center-align" },
    { field: "postName", headerName: "Người đăng", width: 200, cellClassName: "center-align" },
    { field: "studentName", headerName: "Người gửi", width: 200, cellClassName: "center-align" },
];
...
export default function DataTable() {
    ...
    const handleOpen = () => {
        ...
        if (selectedRows.length === 0) {
            enqueueSnackbar(
                "You haven't selected a RideRequest to seen!",
                { variant: "error" }
            );
            return;
        }
        if (selectedRows.length > 1) {
            enqueueSnackbar(
                "Please select only one RideRequest!",
                { variant: "error" }
            );
            return;
        }
    ...
    const transformData = (data) => {
        return data.map(item => ({
            ...
            postName: item.post.student.name,
            studentName: item.passenger.name,
    ...
    const fetchData = async () => {
        try {
            const response = await getRideRequestManagerService();
        ...
        <div className="GridData-Header">
            <div className="GridData-Global">
                ...
                >
                    ...
                    >
                        <h2 id="modal-title">Chi tiết yêu cầu</h2>
                        ...
                        <div className="dou-css">
                            ...
                            <TextField
                                ...
                                variant="outlined"
                                value={selectedPost?.estimatedTime || ""}
